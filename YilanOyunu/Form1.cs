...
namespace YilanOyunu
{
    public partial class Form1 : MetroForm
    {
        ...
        private void YemCiz(Graphics g)
        {
            ...
            g.FillRectangle(Brushes.Yellow, x, y, bogumBoyut, bogumBoyut);
            g.DrawRectangle(Pens.Purple, x, y, bogumBoyut - 1, bogumBoyut - 1);
        }
        ...
        private void BogumCiz(Graphics g, int sutunNo, int satirNo, bool basMi = false)
        {
            ...
            g.FillRectangle(basMi ? Brushes.Purple : Brushes.White, x, y, bogumBoyut, bogumBoyut);
            g.DrawRectangle(Pens.Purple, x, y, bogumBoyut - 1, bogumBoyut - 1);
        }
